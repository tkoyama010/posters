...
\lstinputlisting[caption=Circular arc to plot, label=CircularArc, firstline=8, lastline=17]{kitchen.py}
\begin{figure}
\includegraphics[width=1.0\linewidth]{kitchen.png}
\caption{Circular arc to plot \label{CircularArcToPlot}}
\end{figure}
\end{block}
\lstinputlisting[caption=Plotting over circular arc, label=kitchen, firstline=10, lastline=18]{kitchen.py}
\begin{figure}
